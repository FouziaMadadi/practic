...
const COLOR_GRAY = Color.fromRGBO(141, 141, 141, 1.0);
...
const TextTheme TEXT_THEME_DEFAULT = TextTheme(
  ...
  bodyMedium: TextStyle(
      color: COLOR_GRAY, fontSize: 14, fontWeight: FontWeight.w500, height: 1.5),
  titleMedium: TextStyle(
    color: COLOR_BLACK, fontSize: 12, fontWeight: FontWeight.w400),
  titleSmall: TextStyle(
      color: COLOR_GRAY, fontSize: 12, fontWeight: FontWeight.w400),
);
const TextTheme TEXT_THEME_SMALL = TextTheme(
  ...
  bodyMedium: TextStyle(
      color: COLOR_GRAY, fontSize: 12, fontWeight: FontWeight.w500, height: 1.5),
  titleMedium: TextStyle(
      color: COLOR_BLACK, fontSize: 12, fontWeight: FontWeight.w400),
  titleSmall: TextStyle(
      color: COLOR_GRAY, fontSize: 12, fontWeight: FontWeight.w400),
